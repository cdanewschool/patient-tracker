...
(
	'conditionsService',
	[
	 	'$http','$q','$timeout','model','conditionsModel','trackersModel','vitalsModel','medicationsModel','constants','fhir-factory','utilities',
	 	function($http,$q,$timeout,model,conditionsModel,trackersModel,vitalsModel,medicationsModel,constants,adapter,utilities)
	 	{
	 		return {
